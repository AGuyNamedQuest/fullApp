  ...
  return (
    <ScreenDesktop className={props.className} >
      <HeroContent >
        <Breadcrumb3 >
          <Frame45 >
            <Home  src={`assets/images/breadcrumbs_Home.png`} alt={"Home"}/>
          </Frame45>
          <Separator  src={`assets/images/breadcrumbs_Separator_2.png`} alt={"Separator"}/>
          <CompanySwag >
            {`Company Swag`}
              </CompanySwag>
          <Separator1  src={`assets/images/breadcrumbs_Separator_1.png`} alt={"Separator"}/>
          <Clothing >
            {`Clothing`}
              </Clothing>
          <Separator2  src={`assets/images/breadcrumbs_Separator.png`} alt={"Separator"}/>
          <Latest >
            {`Latest`}
              </Latest>
        </Breadcrumb3>
