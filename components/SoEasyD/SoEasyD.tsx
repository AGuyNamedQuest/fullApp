...
import { SoEasyDProps } from 'types';
import { animated, useSpring, easings } from 'react-spring';
import useSoEasyD from 'components/SoEasyD/useSoEasyD';
...
const HighlightedBar: any = animated(
  styled('div', {
    ...
    margin: `0px`,
    alignSelf:
      data.currentVariant === 'ScreenDesktopStep3' ? `stretch` : 'unset',
  }))
);
...
function SoEasyD(props: SoEasyDProps): JSX.Element {
  const { data, fns } = useSoEasyD();

  const HighlightedBarScreenDesktopStep1 = { width: `837px` };
  const HighlightedBarScreenDesktopStep2 = { width: `837px` };
  const HighlightedBarScreenDesktopStep3 = { width: '1082px' };
  ...
  const Rectangle139ScreenDesktopStep2 = { width: `408px` };
  const Rectangle139ScreenDesktopStep3 = { width: `793px` };
  ...
  const Rectangle141ScreenDesktopStep1 = { width: `243px` };
  const Rectangle141ScreenDesktopStep2 = { width: `214px` };
  const Rectangle141ScreenDesktopStep3 = { width: `287px` };
  ...
  const ExportDesignScreenDesktopStep1 = { color: `rgba(254, 136, 136, 1)` };
  const ExportDesignScreenDesktopStep2 = { color: `rgba(255, 255, 255, 0.5)` };
  ...
  const SetupInQuestScreenDesktopStep2 = { color: `rgba(254, 136, 136, 1)` };
  const SetupInQuestScreenDesktopStep3 = { color: `rgba(255, 255, 255, 0.5)` };
  ...
  const ExportReactScreenDesktopStep3 = { color: `rgba(254, 136, 136, 1)` };
    ...
    <ScreenDesktopStep1>
      <D>
        ...
        {data.currentVariant === 'ScreenDesktopStep3' && (
          <StepVisual3D
            src={`assets/images/SoEasyD_Step_Visual3_D.png`}
            loading="lazy"
            alt={'Step Visual3-D'}
          />
        )}
        {data.currentVariant === 'ScreenDesktopStep2' && (
          <StepVisual2D
            src={`assets/images/SoEasyD_Step_Visual2_D.png`}
            loading="lazy"
            alt={'Step Visual2-D'}
          />
        )}
        {!(data.currentVariant === 'ScreenDesktopStep2') &&
          !(data.currentVariant === 'ScreenDesktopStep3') && (
            <StepVisual1D
              src={`assets/images/SoEasyD_Step_Visual1_D.png`}
              loading="lazy"
              alt={'Step Visual1-D'}
            />
          )}
