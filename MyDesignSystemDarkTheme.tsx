...
const globalTheme: any = createTheme({
  palette: {
    ...
    primary: {
      ...
      light: 'rgba(255, 170, 170, 1)',
      dark: 'rgba(234, 98, 98, 1)',
      contrastText: 'rgba(0, 0, 0, 0.87)',
    },
    secondary: {
      main: 'rgba(128, 102, 255, 1)',
      light: 'rgba(192, 178, 255, 1)',
      dark: 'rgba(85, 52, 242, 1)',
      contrastText: 'rgba(0, 0, 0, 0.87)',
    },
    error: {
      main: 'rgba(255, 44, 94, 1)',
      light: 'rgba(255, 126, 157, 1)',
      dark: 'rgba(210, 27, 71, 1)',
    ...
    success: {
      main: 'rgba(1, 252, 132, 1)',
      light: 'rgba(88, 255, 175, 1)',
      dark: 'rgba(0, 217, 113, 1)',
      contrastText: 'rgba(0, 0, 0, 0.87)',
    },
    info: {
      main: 'rgba(3, 195, 255, 1)',
      light: 'rgba(87, 215, 255, 1)',
      dark: 'rgba(0, 161, 211, 1)',
      contrastText: 'rgba(0, 0, 0, 0.87)',
    },
    text: {
    ...
    Secondary: {
      ...
      Contrast: 'rgba(0, 0, 0, 0.87)',
      Shades: {
        '8p': 'rgba(128, 102, 255, 0.08)',
        '16p': 'rgba(128, 102, 255, 0.16)',
        '12p': 'rgba(128, 102, 255, 0.12)',
        '30p': 'rgba(128, 102, 255, 0.3)',
        '50p': 'rgba(128, 102, 255, 0.5)',
      },
    },
    Action: {
      ...
      MuiButton: {
        styleOverrides: {
          ...
          outlinedSecondary: {
            ...
            border: `3px solid rgba(2, 122, 209, 1)`,
            boxSizing: `border-box`,
            color: `rgba(0, 0, 0, 0.87)`,
            '&:hover': {
              backgroundColor: globalTheme.palette['Text']['Primary'],
          ...
          outlinedError: {
            backgroundColor: globalTheme.palette['Error']['Contrast'],
          ...
          outlinedWarning: {
            backgroundColor: globalTheme.palette['Error']['Contrast'],
            border: `3px solid rgba(245, 161, 83, 1)`,
            boxSizing: `border-box`,
            color: `rgba(0, 0, 0, 0.87)`,
            '&:hover': {
              backgroundColor: globalTheme.palette['Error']['Contrast'],
              border: `3px solid rgba(255, 144, 64, 1)`,
              boxSizing: `border-box`,
              color: `rgba(0, 0, 0, 0.87)`,
            },
            '&:disabled': {
        ...
        styleOverrides: {
          root: {
            '&.MuiRadio-colorPrimary': {
              ...
              '&:hover': {
                backgroundColor: `rgba(174, 172, 255, 0.08)`,
              },
            },
            '&.MuiRadio-colorSecondary': {
              ...
              '&:hover': {
                backgroundColor: `rgba(128, 102, 255, 0.08)`,
              },
            },
            '&.MuiRadio-colorError': {
              color: `rgba(255, 255, 255, 0.7)`,
        ...
        styleOverrides: {
          ...
          track: {
            ...
            '.Mui-checked.MuiSwitch-colorError.Mui-checked + &': {
              backgroundColor: 'rgba(255, 44, 94, 1)',
            },
            '.MuiSwitch-colorWarning + &': {
              borderRadius: '10px',
              backgroundColor: 'rgba(255, 255, 255, 1)',
            ...
            '.Mui-checked.MuiSwitch-colorSuccess.Mui-checked + &': {
              backgroundColor: 'rgba(1, 252, 132, 1)',
            },
            '.MuiSwitch-colorInfo + &': {
              borderRadius: '10px',
              backgroundColor: 'rgba(255, 255, 255, 1)',
